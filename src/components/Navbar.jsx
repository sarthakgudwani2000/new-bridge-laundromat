...
export default function Navbar() {
  ...
  const links = [
    ...
    { href: BERGEN_SITE_URL, label: BRAND.pickup, short: "Bergen", active: false },
    { href: NEW_BRIDGE_SITE_URL, label: "New Bridge Laundromat", short: "New Bridge", active: pathname === NEW_BRIDGE_PATH },
    { href: SINGH_ABOUT_URL, label: "About Us", short: "About" },
    { href: SINGH_CONTACT_URL, label: "Contact Us", short: "Contact" },
  ];
  const isBergenPickupPage = false;
  ...
  // ── DEBUG LOGGING ──────────────────────────────────────────────
  useEffect(() => {
    console.group("%c[New Bridge Navbar] location update", "color:#0f766e;font-weight:bold");
        ...
        <div className="container-pad">
          <div className="flex h-[4.25rem] md:h-[4.5rem] items-center justify-between gap-4 lg:gap-8">
            <Link
              ...
              aria-label={`${BRAND.store} — ${BRAND.parent} home`}
            >
              <div
                ...
                {links.map((l) => (
                  <li key={l.to ?? l.href}>
                    {l.href ? (
                      <a
                        href={l.href}
                        onClick={() => console.log("%c[New Bridge Navbar] tab click → EXTERNAL", "color:#15803d;font-weight:bold", { label: l.label, href: l.href })}
                      ...
                      <NavLink
                        ...
                        onClick={() => console.log("%c[New Bridge Navbar] tab click → INTERNAL", "color:#9333ea;font-weight:bold", { label: l.label, to: l.to })}
                        className={({ isActive }) =>
                          [
