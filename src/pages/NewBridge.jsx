...
import { BRAND, PRICING, LOCATIONS, HOURS, IMAGES, SCHEDULE_ORDER_URL, LOCAL_BUSINESS_JSON_LD } from "@/lib/brand";
...
export default function NewBridge() {
  ...
  return (
    ...
    >
      <Seo
        title="New Bridge Laundromat | Bergenfield, NJ Laundromat"
        description="New Bridge Laundromat is Bergenfield, NJ's self-service laundromat — coin-operated machines, wash dry fold drop-off, and free parking at 97 New Bridge Rd."
      ...
      <section className="page-hero-section pb-5 max-w-5xl" data-reveal-blur>
        ...
        <h2 className="mt-3 max-w-2xl mx-auto text-center font-display text-lg md:text-xl font-semibold text-slate-700">
          Self-Service Laundromat &amp; Wash, Dry &amp; Fold Drop-Off in Bergenfield, NJ 07621
        </h2>
        <span
