...
export default function Contact() {
  ...
  return (
    ...
    >
      <Seo
        title="Contact New Bridge Laundromat | Bergenfield, NJ"
        description="Contact New Bridge Laundromat in Bergenfield, NJ for hours, directions, or wash dry fold drop-off questions. Call or visit 97 New Bridge Rd."
        path="/contact"
