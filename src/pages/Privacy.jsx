...
export default function Privacy() {
  ...
  return (
    ...
    >
      <Seo
        title="Privacy Policy | New Bridge Laundromat"
        description="Read New Bridge Laundromat's privacy policy covering how we collect and protect customer information in Bergenfield, NJ."
        path="/privacy"
