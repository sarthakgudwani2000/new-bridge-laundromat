...
export default function Services() {
  ...
  return (
    ...
    >
      <Seo
        title="Laundromat Services in Bergenfield, NJ | New Bridge"
        description="See all services at New Bridge Laundromat: self-serve machines, coin-operated laundry, and wash dry fold drop-off in Bergenfield, NJ."
        path="/services"
      ...
      <section className="page-hero-section max-w-none" data-reveal-blur>
        ...
        <h1 className="h1 lg:whitespace-nowrap">Our Laundromat Services in Bergenfield, NJ</h1>
        <span
