...
export default function About() {
  ...
  return (
    ...
    >
      <Seo
        title="About New Bridge Laundromat | Bergenfield, NJ"
        description="Learn about New Bridge Laundromat, Bergenfield NJ's newly renovated coin-operated laundromat serving Bergen County with self-serve and wash & fold care."
        path="/about"
        image={IMAGES.logoNewBridge}
      />
      <section className="page-hero-section" data-reveal-blur>
        <h1 className="h1">About New Bridge Laundromat</h1>
        <span
