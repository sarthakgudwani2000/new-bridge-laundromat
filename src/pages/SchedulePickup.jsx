...
import { BRAND, IMAGES, PRICING, PICKUP_WINDOWS, SERVICE_TYPES } from "@/lib/brand";
...
export default function SchedulePickup() {
  ...
  if (done) {
    return (
      ...
      >
        <Seo
          title="Schedule Laundry Pickup | New Bridge Laundromat"
          description="Schedule your wash dry fold drop-off pickup window with New Bridge Laundromat in Bergenfield, NJ. Quick, easy scheduling in about a minute."
