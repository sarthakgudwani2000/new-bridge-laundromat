...
export const SITE_URL = "https://newbridgelaundromat.com/";
...
/** JSON-LD: laundromat LocalBusiness — built only from data already above (no fabricated geo/ratings). */
export const LOCAL_BUSINESS_JSON_LD = {
  "@context": "https://schema.org",
  "@type": ["LocalBusiness", "LaundryOrDryCleaning"],
  name: BRAND.store,
  image: new URL(IMAGES.logoNewBridge, SITE_URL).href,
  telephone: BRAND.phoneStore,
  url: SITE_URL,
  address: {
    "@type": "PostalAddress",
  ...
  sameAs: [
    SOCIAL.newBridge.facebook,
    SOCIAL.newBridge.instagram,
    SOCIAL.newBridge.yelp,
    SOCIAL.newBridge.google,
  ],
};
